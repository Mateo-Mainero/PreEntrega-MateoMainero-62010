...
function calcularPagoMensual(monto, tasaInteresAnual, meses) {
    ...
    function manejarEnvioFormulario(event) {
        ...
        document.getElementById('resultado').innerText = 'El pago mensual del préstamo es: $' + pagoMensual.toFixed(2) + '. El total del préstamo con intereses es:$' + totalConIntereses.toFixed(2);
        console.log ('El pago mensual del préstamo es: $' + pagoMensual.toFixed(2) + '. El total del préstamo con intereses es:$' + totalConIntereses.toFixed(2) )
        alert ( 'El pago mensual del préstamo es: $' + pagoMensual.toFixed(2) + '. El total del préstamo con intereses es:$' + totalConIntereses.toFixed(2))
